...
class Request(models.Model):
    ...
    area_name = models.CharField(max_length=100, default="Unknown Area")
...
class Task(models.Model):
    ...
    verified_by_supervisor = models.CharField(max_length=200, blank=True, null=True)
